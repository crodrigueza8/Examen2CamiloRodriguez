...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AskStatusId).HasName("PK__AskStatu__0329362CC6F06655");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Country__10D160BF91B9BEAE");
        ...
        {
            entity.HasKey(e => e.Idconfig).HasName("PK__General__3E2AEF2A2153A458");
        ...
        {
            entity.HasKey(e => e.LikeId).HasName("PK__Like__A2922CF45A806211");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC2793C63C");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A550ECD2C72");
        ...
        {
            entity.HasKey(e => e.UserStatusId).HasName("PK__UserStat__A33F541AF56DBAA3");
